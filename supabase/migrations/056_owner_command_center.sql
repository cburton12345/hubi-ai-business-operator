...
values
  ...
  ('11111111-1111-4111-8111-111111111111', 'slashboard', 'Slashboard', 'seed-slashboard-port', 'system.direction', 'Slashboard direction folded into Ferocity', 'The standalone prototype is now the spec for the Ferocity Owner Command Center.', 'info', 'resolved', false, true, 'AI recorded the architecture decision.', 'Build future owner command work inside Ferocity.', '/app/owner-command-center', 0, 'approval', 95, '{"source":"seed"}'::jsonb, now() - interval '10 hours')
