...
const requiredFiles = [
  ...
  "docs/launch-secret-rotation-and-provider-handoff-2026-08-02.md",
  "docs/launch-seven-checkpoints-2026-08-02.md",
  "docs/next-ten-launch-gates-2026-08-02.md",
  "docs/customer-onboarding-runbook.md",
  "docs/launch-closeout-100.md",
  "scripts/run-migrations.mjs",
  "scripts/rotate-credential-vault-key.mjs",
  "scripts/update-stripe-connect-contact.mjs",
  "scripts/create-stripe-connect-onboarding-link.mjs",
  "scripts/stripe-connect-readiness.mjs",
  "scripts/stripe-connect-reconcile.mjs",
  "scripts/retell-readiness.mjs",
  "scripts/retell-call-certification-preflight.mjs",
  "scripts/jobber-oauth-readiness.mjs",
  "scripts/provider-credential-health.mjs",
  "scripts/featured-demo-readiness.mjs",
  "scripts/stripe-connect-payment-preflight.mjs",
  "public/ferocity-demo-walkthrough.svg",
  "src/components/public/FeaturedDemoMedia.tsx",
  "src/components/public/PublicCommandStory.tsx",
  "src/lib/payments/provider-contact-email.ts",
  ...
  "scripts/public-claim-readiness.mjs",
  ...
  "src/components/public/BusinessLoopDemo.tsx",
  ...
  "supabase/migrations/166_ai_agent_run_lifecycle.sql",
  "supabase/migrations/167_public_operating_system_story.sql",
  "supabase/migrations/168_marketing_video_finished_assets.sql",
  "supabase/migrations/169_certified_golden_business_loop.sql",
  "supabase/migrations/170_business_loop_certification_policy_hardening.sql",
  "supabase/migrations/171_sharpen_homepage_hero.sql"
];
