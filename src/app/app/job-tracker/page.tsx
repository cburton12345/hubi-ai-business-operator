...
export default async function JobTrackerPage() {
  ...
  return (
    <QueuePageShell
      ...
      description="A simple partner-friendly view for what was bid, what is active, what has been paid out, what materials are needed, and what money is still left in each job."
    >
      ...
      <section className="grid section-actions">
        <section className="panel span-5">
          ...
          <p className="muted">Use this when an employee or subcontractor bought something and needs paid back. Owners can approve it, pay it, or reject it.</p>
          <form action={createReceiptExpenseAction} className="stacked-form">
            ...
            <label>
              Notes
              <textarea name="notes" rows={3} placeholder="What was bought and why" />
            </label>
