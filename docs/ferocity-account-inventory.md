...
| Meta / Facebook | Meta Developers app `Ferocity` under Ferocity Operations | Configured in Netlify production env | `META_APP_ID`, `META_APP_SECRET`, `META_OAUTH_REDIRECT_URI`, `META_BUSINESS_LOGIN_CONFIG_ID` | Netlify env vars / password manager |
